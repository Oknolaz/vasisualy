...
class MainWindow(QtWidgets.QMainWindow, design.Ui_MainWindow):
    ...
    def program(self):
        ...
        for i in k_chemu:
            if i in say:
                k_tomu = random.choice(("Ничего...", "Так...", "Просто...", "Забудь.", "Нет, ничего.", "Я. Так.", "Да, ничего. Забудь.", "Ничего.", "Я ошибся.", "А вы к чему?", "Просто так."))
                self.speak(k_tomu)
                cnt_speak += 1
                if cnt_speak == 1: break
            else:
        ...
        for i in call:
            if i in say:
                cal = random.choice(("Я такого не могу.", "Извините, я не телефон.", "Разве я похож на телефон.", "Я не умею звонить.", "Абонент недоступен, пожалуйста, перезвоните позднее.", "Не нужно заставлять меня делать то, чего я не умею.", "Я не буду этим заниматься!"))
                self.speak(cal)
                cnt_speak += 1
                if cnt_speak == 1: break
            else:
        ...
        for i in ugu:
            if i == say:
                aga = random.choice(("Ага.", "Очень интересно.", "Вам нечего делать?", "Почему человеки такие глупые?", "...", "Да.", "Как обычно.", "Зачем Вы это говорите?"))
                self.speak(aga)
                cnt_speak += 1
                if cnt_speak == 1: break
            else:
