...
video = ("Найди видео", "найди видео", "Поиск видео", "поиск видео", "Найти видео", "найти видео", "Включи видео", "включи видео", "Давай видео", "давай видео", "Ищи видео", "ищи видео") # Команды поиска видео в Youtube
    ...
    def program(self):
        ...
        for i in maps:
            if i in say:
                ...
                self.show_dialog()
                self.speak("Я надеюсь, ты найдёшь то, что тебе нужно.")
                cnt_speak += 1
                if cnt_speak == 1: break
            else:
                cnt += 1
