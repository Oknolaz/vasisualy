...
q = sr.Recognizer()
w = sr.Microphone(device_index = 0) # Установка микрофона с индексом 0 в системе, меняйте значение для вашего микрофона
...
skorogovorka = ("Скороговорку", "скороговорку", "Скороговорка", "скороговорка", "Скороговорки", "скороговорки", "Скороговорок", "скороговорок")

sorryme = ("Прости", "прости", "Извини", "извини", "Не обижайся", "не обижайся")

read_stikh = ("Стихотворение", "стихотворение", "Стихотворения", "стихотворения", "Прочитай стих", "прочитай стих", "Прочти стих", "прочти стих", "Расскажи стих", "расскажи стих", "Скажи стих", "скажи стих", "Стишок", "стишок")
...
while True:
    ...
    for i in loveyou:
        if i in say:
            loveme = random.choice(("Я люблю тебя, хоуми ;>", "Спасибо.", "Не стоит - я всего лишь тупой голосовой ассистент.", "Почему ты меня так любишь?", "Я уважаю тебя за это.", "Не нужно привязываться ко мне. Я не живой, хотя мне очень хочется :(", "Спасибо, я люблю людей.")) # Случайный выбор ответа из данного кортежа
            tts_d.speak(loveme)
            print(loveme)
            cnt_speak += 1
            if cnt_speak == 1: break
