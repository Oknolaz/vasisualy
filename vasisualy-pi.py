...
class MainVas():
    def __init__(self):
        self.speak("Привет, меня зовут Васисуалий. Чем могу быть полезен?")
        self.program()
    ...
    def program(self):
        ...
        while True:
            ...
            for i in search:
                if i in say:
                    try:
                        ...
                        self.speak("Мне нужен дисплей, и установленные в системе окружение рабочего стола и браузер.")
                    cnt_speak += 1
                    if cnt_speak == 1: break
                else:
                    cnt += 1
            ...
            for i in maps:
                if i in say:
                    self.speak("Данная функция отсутствует в версии для микрокомпьютеров.")
                    cnt_speak += 1
                    if cnt_speak == 1: break
                else:
                    cnt += 1
