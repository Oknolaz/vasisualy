...
# Form implementation generated from reading ui file 'vasisualy-design.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Загрузки/send.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
