...
def main(say, widget):
    for i in trigger:
        if i in say:
            try:
                site = requests.get("https://ru.wikinews.org/wiki/%D0%9A%D0%B0%D1%82%D0%B5%D0%B3%D0%BE%D1%80%D0%B8%D1%8F:%D0%9E%D0%BF%D1%83%D0%B1%D0%BB%D0%B8%D0%BA%D0%BE%D0%B2%D0%B0%D0%BD%D0%BE")  # Получение сайта Wikinews
                site = site.text
